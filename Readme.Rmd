...
This is the regex to extract features like party_leder (group) for each legislative period. 
...
comparision of PMs who switch to government status (at least once). 
